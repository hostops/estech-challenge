...
import { SystemUnitComponent } from 'app/entities/system-unit/system-unit.component';
...
describe('Component Tests', () => {
    describe('SystemUnit Management Component', () => {
        let comp: SystemUnitComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SystemUnitComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.systemUnits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
